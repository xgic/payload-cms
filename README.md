...
```text
ghcr.io/xgic/payload-cms-dev:0.3.2
```
...
| **Reproducible pins** | Semver image tags (e.g. `0.3.2`) match producer releases |
...
| Tag | Use when |
|-----|----------|
| `:0.3.2` (semver) | **Default for app work** — matches producer [v0.3.2](https://github.com/xgic/payload-cms-dev/releases/tag/v0.3.2) |
| `:latest` / `:main` | You deliberately want rolling producer `main` (less reproducible) |

```bash
docker pull ghcr.io/xgic/payload-cms-dev:0.3.2
```
